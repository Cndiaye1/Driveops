        ...
        <div className="topbarRight">
          ...
          {canUseTopActions && (
            <div className="actions noPrint" onClick={(e) => e.stopPropagation()}>
              <button className="btn ghost" onClick={() => setWallMode(true)} style={ui.btnGhost} type="button">
                🧱 Mode Mur
              </button>
          ...
          {wallMode && !printMode && (
            <div className="actions noPrint">
              <button className="btn ghost" onClick={() => setWallMode(false)} style={ui.btnGhost} type="button">
                ⬅️ Quitter Mode Mur
              </button>
            </div>
          )}
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
            ...
            {pausesOngoing.map((x) => (
              <div
                key={x.nom}
                className="pill"
                style={{ gap: 10, ...ui.topStat, borderRadius: 12 }}
              >
                <span>
