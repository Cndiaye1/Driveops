// src/components/cockpit/CockpitCallouts.jsx
import React from "react";

export default function CockpitCallouts({
  ui,
  canUseTopActions,
  missingAssignments,
  onAutoFillMissing,
        ...
        <div className="card callout danger" onClick={(e) => e.stopPropagation()} style={ui.panel}>
          <div style={{ display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" }}>
            ...
            {canUseTopActions && (
              <button
                className="btn ghost"
                onClick={onReturnAllEndedPauses}
              ...
              <div key={x.nom} className="pill" style={{ gap: 10, ...ui.topStat, borderRadius: 12 }}>
                ...
                {canUseTopActions && (
                  <button
                    ...
                    onClick={() => onReturnFromPause(String(currentBlockId), x.nom)}
            ...
            {canUseTopActions && (
              <>
                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                  ...
                  >
                    {Array.from(
                      { length: Math.max(1, Math.min(dayStaffLength || 1, 6)) },
                      (_, i) => i + 1
                    ).map((v) => (
                ...
                <button className="btn ghost" onClick={autoPickPauseWave} style={ui.btnGhost} type="button">
                  🎯 Auto
                </button>
